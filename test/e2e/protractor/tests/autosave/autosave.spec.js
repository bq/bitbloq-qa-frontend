...
describe('Check makeActions actions in codeProjects', function() {
    ...
    xit('bba-244:Verify that the autosave is launched when you delete a board or a robot', function() {
        //BOARD
    ...
    xit('bba-280:Verify that the autosave is launched when you delete a component', function() {
    ...
    xit('bba-281:Verify that the autosave is launched when you disconnect a component', function() {
