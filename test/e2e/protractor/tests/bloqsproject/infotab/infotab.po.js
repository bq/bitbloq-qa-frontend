...
var Infotab = function() {
    ...
    this.infotabOptionGrayTheme = $('[data-element="infotab-choosetheme-0"]');
    this.infotabOptionColorTheme = $('[data-element="infotab-choosetheme-1"]');
    ...
    this.infotabBQZumButton = $('[data-element="infotab-chooseboard-0"]');
};
