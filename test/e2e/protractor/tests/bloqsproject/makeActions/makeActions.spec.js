...
describe('Check makeActions actions in bloqsproject', function() {
    ...
    it('SWBIT-3020:bloqsprojectMakeActions:check enabled/disabled options by logged in user', function() {
     ...
     * User not logged in
     */
    it('SWBIT-2939:bloqsprojectMakeActions:check enabled/disabled options by not logged in user', function() {
