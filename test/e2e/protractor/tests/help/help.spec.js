...
describe('Help ', function() {
    ...
    it('bbb-194:help:Comprobar botones Informar de un error en usuario invitado', function() {
        help.get();
    ...
    it('bbb-191:help:Comprobar botones Informar de un error en usuario registrado', function() {
