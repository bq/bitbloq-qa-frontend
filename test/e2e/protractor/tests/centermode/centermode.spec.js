...
describe('Center mode', function() {
    ...
    it('SWBIT-3368:centermode:Create a center', function() {
        centermode.createHeadMaster();
    });

    it('SWBIT-3369:centermode:Create a center by user <14', function() {
    ...
    it('SWBIT-3370:centermode:Create a center with empty fields', function() {
        login.loginWithRandomUser();
        header.openHeaderMenu.click();
    ...
    it('SWBIT-3371:centermode:Create a center with wrong field', function() {
        login.loginWithRandomUser();
        header.openHeaderMenu.click();
        header.centerModeBanner.click();
    ...
    it('SWBIT-3372:centermode:Create center option dissapear if the user have a center', function() {
        centermode.createHeadMaster({
            keepLogin: true
        });
        header.openHeaderMenu.click();
    ...
    it('SWBIT-3373:centermode:The tabs of center mode', function() {
