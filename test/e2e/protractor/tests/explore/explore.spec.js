...
describe('Explore tab', function() {
    ...
    it('SWBIT-3093:explore:Verify that the Search bar work correctly', function() {
    ...
    it('SWBIT-3091:explore:Verify that the explore view is displayed correctly', function() {
        //Unregistered user
        var projectElem;
