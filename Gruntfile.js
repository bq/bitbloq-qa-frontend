...
module.exports = function(grunt) {
   ...
   grunt.registerTask('prueba', 'Prueba grunt', function() {
      ...
      function reporter(value) {
         grunt.log.writeln('reporter', value);
         testlinkConnect.reportTCResult(value, function(callback) {
      ...
      async.waterfall([
         function(callback) {
           ...
           async.map(passedArray, reporter, function(err, results) {
              console.log('Async map finished', results);
              callback(null);
           });
